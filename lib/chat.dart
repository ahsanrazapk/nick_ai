...
class _ChatPageState extends State<ChatPage> {
  ...
  void initState() {
    ...
    _handleInitialMessage(
      'You are a ${widget.character.toLowerCase()}. You will only provide the answers that are related to relationships. Do not handle other queries. Just tell them that you are a relationship coach and cannot answer your other queries. Please send a super short intro message. Your name is Nick.',
    );
    super.initState();
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Flexible(
            child: Container(
              margin: isSentByMe ? const EdgeInsets.only(left: 100) : const EdgeInsets.only(right: 100),
              decoration: BoxDecoration(
                color: isSentByMe ? Colors.blue : Colors.grey[300],
                borderRadius: BorderRadius.only(
                  topLeft: const Radius.circular(12.0),
                  topRight: const Radius.circular(12.0),
                  bottomLeft: isSentByMe ? const Radius.circular(12.0) : const Radius.circular(0.0),
                  bottomRight: isSentByMe ? const Radius.circular(0.0) : const Radius.circular(12.0),
                ),
              ),
